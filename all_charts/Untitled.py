...
df = pd.read_csv('/home/subir/anaconda3/notebook/corona/full_data_india.csv')
...
for i in range(6,10)[::-1]:
    ...
    message="Detemining frame "+ str(df_month)
    print(message)
...
fig.update_layout(
    title = go.layout.Title(
        text = 'Ebola cases reported by month in WHO 2020<br> \
...
colors = ['rgb(239,243,255)','rgb(189,215,231)','rgb(107,174,214)','rgb(33,113,181)']
months = {3:'Mar',7:'July',8:'Aug',9:'Sept'}
